...
const MessengerSendMessagesSystem = async (
  ...
  for (const messageItem of messages) {
    ...
    try {
      ...
      // enviar old_id para reemplazar en el front el mensaje correctamente
      ...
      socketEmit({
        ...
        payload: {
          ...message.dataValues,
          mediaUrl: message.mediaUrl, // necesario para enviar error en el socket - call size
          id: message.id,
          timestamp: message.timestamp,
          messageId: sendedMessage.messageId,
          status: "sended",
      ...
      // delay para procesamiento del mensaje
