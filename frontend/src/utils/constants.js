...
export const estadosBR = [
  ...
  { nome: 'Mato Grosso del Sur', sigla: 'MS' },
  ...
  { nome: 'Piauí', sigla: 'PI' },
  { nome: 'Río de Janeiro', sigla: 'RJ' },
  { nome: 'Río Grande del Norte', sigla: 'RN' },
  { nome: 'Río Grande del Sur', sigla: 'RS' },
...
export const messagesLog = {
  ...
  autoClose: {
    message: 'Bot: Atención cerrada por el cliente',
    color: 'blue-8',
    icon: 'mdi-check-circle-outline'
  }
}