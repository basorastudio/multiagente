  ...
  <div class="q-px-md q-py-sm">
    ...
    >
                  ...
                  <template v-for="(condition, idx) in node.conditions">
                    ...
                    >
                      ...
                      <q-card-section class="q-pa-sm">
                        <div class="text-bold q-px-sm"> Redirigir a: </div>
                        <q-option-group
                          class="text-center"
                          inline
      ...
      >
        ...
        >
          <div class="full-width bg-grey-3 text-bold row col justify-between text-left q-pa-md">
            ...
            <div class="row text-subtitle2">
              Cuando el bot redirija el atendimiento a una fila o usuario,
        ...
        >
          <div class="full-width bg-grey-3 text-bold row col justify-between text-left q-pa-md">
            Si ninguna respuesta esperada es enviada
            <div class="row text-subtitle2">
        ...
        >
          <div class="full-width bg-grey-3 text-bold text-body1 row col justify-between text-left q-pa-md">
            ...
            <div class="row text-subtitle2">
              ...
              el bot realizará el encaminamiento a la Fila/Usuario informados.
            </div>
          </div>
          <q-card-section class="q-pa-sm">
            <div class="row q-mt-sm">
        ...
        >
          <div class="full-width bg-grey-3 text-bold text-body1 row col justify-between text-left q-pa-md">
            ...
            <div class="row text-subtitle2">
              ...
              si el cliente no envía una respuesta válida, el bot realizará el encaminamiento
        ...
        >
          <div class="full-width bg-grey-3 text-bold text-body1 row col justify-between text-left q-pa-md">
            Auto Distribuir Atendimiento
            <div class="row text-subtitle2">
              No: Desactivado. <br />
              Balancear: Definirá el usuario en base a la cantidad de atendimientos de cada usuario de la fila. El usuario con
              menos atendimientos será seleccionado.<br />
              Aleatorio: Definirá el usuario de forma aleatoria para los usuarios de la fila.
            </div>
          </div>
          <q-card-section class="q-pa-sm">
            <div class="row q-mt-sm">
        ...
        >
          <div class="full-width bg-grey-3 text-bold text-body1 row col justify-between text-left q-pa-md">
            Cerrar Atendimiento
            <div class="row text-subtitle2">
              Si el cliente escribe alguna de las informaciones esperadas, el atendimiento será cerrado.
            </div>
          </div>
          <q-card-section class="q-pa-sm">
            <div class="row q-mt-sm">
      ...
      >
        <q-card class="full-width q-my-sm">
          <div class="full-width bg-grey-3 text-bold row col justify-between text-left q-pa-md">
            La etapa representa el contacto inicial.
            <div class="row text-subtitle2">
              - Si es el primer contacto del cliente, el sistema
              guardará automáticamente en la agenda las informaciones del cliente.
            </div>
            <div class="row text-subtitle2">
              - El Bot interactuará en los atendimientos iniciados por los clientes.
            </div>
            <div class="row text-subtitle2">
              - El Bot dejará de interactuar si el atendimiento es asumido por un usuario.
            </div>
          </div>
        </q-card>
      </q-card-section>
