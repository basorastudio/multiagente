    ...
    >
      ...
      >
        <q-file
          ...
          :loading="loading"
          rounded
          label="Medios de composición de mensaje"
...
export default {
  ...
  methods: {
    ...
    onRejectedFiles (rejectedEntries) {
      this.$q.notify({
        html: true,
        message: `¡Ups... Ha ocurrido un error! <br>
        <ul>
          <li>El archivo debe tener un máximo de 5MB.</li>
          <li>Priorice el envío de imagen o vídeo.</li>
        </ul>`,
        type: 'negative',
        progress: true,
        position: 'top',
