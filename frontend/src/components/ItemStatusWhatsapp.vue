    ...
    return {
      status: {
        PAIRING: {
          ...
          status: 'Emparejando',
          description: 'Emparejando sesión Whatsapp.'
        },
        TIMEOUT: {
          color: 'warning',
        ...
        qrcode: {
          ...
          status: 'Qr Code',
          description: 'Necesario leer el Qr Code'
        },
        DESTROYED: {
          color: 'primary',
          icon: 'mdi-close-network-outline',
          status: 'Inactivo',
          description: 'Necesario iniciar la conexión con Whatsapp y leer el Qr Code.'
        },
        CONFLICT: {
          color: 'warning',
          icon: 'mdi-equal',
          status: 'Conflicto',
          description: 'Whatsapp Web en uso.'
        },
        OPENING: {
          color: 'black',
          icon: 'mdi-connection',
