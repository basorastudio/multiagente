          ...
          <div class="row q-col-gutter-md">
            ...
            <div class="col-12 q-mt-md">
              <q-input
                ...
                hint="Dispara acción siempre que el estado de un mensaje es actualizado."
              />
            </div>
            <div class="col-12 q-mt-md">
              <q-input
                ...
                hint="Será enviado como autorización en el header. Si existe prefijo, deberá ser informado aquí. Ej.: Bearer, Token"
              />
            </div>
          </div>
        </fieldset>
...
export default {
  ...
  methods: {
    ...
    async handleAPI () {
      this.$v.api.$touch()
      if (this.$v.api.$error) {
        this.$notificarErro('Verifique os campos obligatorios e inconsistencias.')
        return
      }
      try {
        this.loading = true
        ...
        console.error(error)
        this.$notificarErro('¡Ocurrió uu error!', error)
      }
    }
  }
