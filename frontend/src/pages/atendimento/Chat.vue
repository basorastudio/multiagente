    ...
    <q-footer class="bg-white">
      ...
      >
        ...
        <q-select
          ...
          hint="Escribe al menos dos letras para localizar el contacto. ¡Es posible seleccionar solo 1 contacto!"
        >
  ...
  methods: {
    ...
    confirmarEncaminhamentoMensagem (data) {
      ...
      EncaminharMensagem(data, this.contatoSelecionado)
        ...
        .catch(e => {
          this.$notificarErro('No fue posible reenviar el mensaje. ¡Intenta de nuevo en unos minutos!', e)
        })
    }
  },
  created () {
