  ...
  >
    ...
    >
      <q-card-section class="q-pa-none q-px-md">
        ...
        <div class="row">
          Los mensajes siempre se enviarán en horario comercial y días laborables.
        </div>
      </q-card-section>
      ...
      <q-card-section class="row q-pt-sm q-gutter-sm justify-center">
        <div style="min-width: 400px;">
          <div class="row items-center q-pt-none">
            <label class="text-heading text-bold">1º Mensaje</label>
  ...
  methods: {
    ...
    async handleCampanha () {
      ...
      if (this.campanha.delay < 61) {
        this.$q.notify({
          type: 'negative',
          message: 'El campo delay debe ser mínimo 61'
        })
        return
      }
