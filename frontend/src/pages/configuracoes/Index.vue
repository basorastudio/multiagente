    ...
    <q-list class="text-weight-medium">
      ...
      >
        <q-item-section>
          ...
          <q-item-label caption>Solo el usuario responsable del ticket y/o los administradores podrán visualizar la atención.</q-item-label>
        </q-item-section>
      ...
      >
        <q-item-section>
          ...
          <q-item-label caption>Solo los administradores podrán visualizar tickets que estén interactuando con el ChatBot.</q-item-label>
        </q-item-section>
        <q-item-section avatar>
          <q-toggle
      ...
      >
        <q-item-section>
          ...
          <q-item-label caption>Si el contacto tiene cartera vinculada, el sistema dirigirá la atención solo a los dueños de la cartera de clientes.</q-item-label>
        </q-item-section>
        <q-item-section avatar>
          <q-toggle
      ...
      >
        <q-item-section>
          ...
          <q-item-label caption>Flujo a utilizar por el Bot para las nuevas atenciones</q-item-label>
        </q-item-section>
        <q-item-section avatar>
          <q-select
            style="width: 300px"
      ...
      >
        <q-item-section>
          ...
          <q-item-label caption>Al habilitar esta opción el sistema no abrirá ticket para grupos</q-item-label>
        </q-item-section>
        <q-item-section avatar>
          <q-toggle
      ...
      <div class="row q-px-md">
        <q-item tag="label" class="col-8" v-ripple>
          <q-item-section>
            <q-item-label>Token NotificaME - Adquiéralo con descuento al +1(829)793-4075</q-item-label>
          </q-item-section>
